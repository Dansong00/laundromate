...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum(
                "WASH_FOLD", "DRY_CLEAN", "PRESS_ONLY", "STARCH", name="servicecategory"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("preferred_pickup_time", sa.String(length=50), nullable=True),
        sa.Column("special_instructions", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("pickup_time_slot", sa.String(length=50), nullable=False),
        ...
        sa.Column("delivery_time_slot", sa.String(length=50), nullable=False),
