        ...
        <section className="relative overflow-hidden pt-16 pb-24 lg:pt-32">
          ...
          <div className="mx-auto max-w-6xl px-4 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600 leading-relaxed">
              Streamline your laundry business with our all-in-one platform.
              From pickup & delivery to in-store POS, LaundroMate handles the
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Branded web and mobile app for your customers to schedule pickups easily.",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Track every garment with digital tagging and photo proof of delivery.",
                },
              ].map((feature, i) => (
                <div
                  key={i}
                  className="bg-white p-8 rounded-2xl border shadow-sm hover:shadow-md transition-shadow"
                >
              ...
              <div className="relative overflow-hidden rounded-3xl bg-blue-600 p-8 md:p-12 text-white shadow-xl">
                <div className="relative z-10">
                  ...
                  <p className="text-blue-100 mb-8 text-lg">
                    Schedule pickups, track your laundry, and manage your
                    account. Fresh clothes are just a tap away.
                  </p>
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 p-8 md:p-12 text-white shadow-xl">
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 mb-8 text-lg">
                    Manage your fleet, staff, and orders from one central
                    dashboard. Take control of your operations.
                  </p>
