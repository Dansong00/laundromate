              ...
              {filteredCustomers.map((customer) => (
                <div 
                  ...
                  className={`grid grid-cols-4 gap-4 items-center p-3 rounded-lg cursor-pointer transition-colors ${
                    selectedCustomer.id === customer.id ? 'bg-blue-50 border border-blue-200' : 'hover:bg-gray-50'
                  }`}
                >
                  <div className="flex items-center space-x-3">
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center space-x-4">
              <Avatar className="w-16 h-16">
                <AvatarFallback className="text-lg">{selectedCustomer.initials}</AvatarFallback>
              </Avatar>
              <div>
