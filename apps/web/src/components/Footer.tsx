        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <ul className="space-y-1">
              <li><Link href="/learn-more" className="text-gray-600 hover:text-gray-900">Learn more</Link></li>
              <li><Link href="/schedule-demo" className="text-gray-600 hover:text-gray-900">Schedule a demo</Link></li>
              <li><Link href="/portal" className="text-gray-600 hover:text-gray-900">Portal</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><a href="mailto:danger091@gmail.com" className="text-gray-600 hover:text-gray-900">Contact Us</a></li>
            </ul>
          </div>
        </div>
